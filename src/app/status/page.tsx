...
export const metadata: Metadata = {
  ...
  description:
    'Monitoreo en tiempo real del estado de los servicios de Broslunas Links. Verifica el uptime, rendimiento y disponibilidad de nuestros sistemas.',
  keywords: [
    'estado',
    'sistema',
    'uptime',
  ...
  openGraph: {
    ...
    description:
      'Monitoreo en tiempo real del estado de nuestros servicios. Verifica la disponibilidad y rendimiento.',
  },
  twitter: {
    title: 'Estado del Sistema - Broslunas Links',
    description:
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-12 mb-12">
            <div className="mb-8">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                Estamos desarrollando un sistema de monitoreo más detallado que
                incluirá:
              </p>
            </div>
