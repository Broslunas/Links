...
function generateCSV(stats: any, link: any): string {
    ...
    stats.clicksByDay.forEach((item: any) => {
    ...
    stats.clicksByCountry.forEach((item: any) => {
    ...
    stats.clicksByDevice.forEach((item: any) => {
    ...
    stats.clicksByBrowser.forEach((item: any) => {
    ...
    stats.clicksByOS.forEach((item: any) => {
