    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Broslunas Links</h3>
              <p className="text-gray-400">
                La plataforma más avanzada para acortar y analizar URLs
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <Link href="/terms-and-services" className="hover:text-white">
                    Términos
                  </Link>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Broslunas Links. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
