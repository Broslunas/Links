...
export default function SettingsPage() {
    ...
    const handleDeleteAccount = async () => {
        ...
        if (!confirm('Esta acción eliminará permanentemente todos tus enlaces y datos analíticos. ¿Continuar?')) {
            return;
        }
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    ...
                                    onChange={(e) => setSettings({ ...settings, defaultPublicStats: e.target.checked })}
                    ...
                    <div className="space-y-4">
                        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                            ...
                            <p className="text-sm text-blue-700 dark:text-blue-200 mb-3">
                                Descarga una copia de todos tus datos incluyendo enlaces y estadísticas.
                            </p>
                            <Button variant="outline" size="sm" className="border-blue-300 text-blue-700 hover:bg-blue-100 dark:border-blue-600 dark:text-blue-200 dark:hover:bg-blue-800">
                                Exportar Datos
                            </Button>
                        </div>
                        ...
                        <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                            ...
                            <Button variant="outline" size="sm" className="border-yellow-300 text-yellow-700 hover:bg-yellow-100 dark:border-yellow-600 dark:text-yellow-200 dark:hover:bg-yellow-800">
                                Eliminar Datos
                            </Button>
                        </div>
                    </div>
