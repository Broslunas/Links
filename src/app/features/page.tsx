...
const FeatureCard = ({ icon, title, description, features, delay = 0 }: {
  ...
  return (
    <div className={`group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 dark:border-gray-700 overflow-hidden ${
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/30">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        {/* Hero Section */}
        <div className={`max-w-6xl mx-auto text-center mb-20 transform transition-all duration-1000 ${
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            <StatCard number="99.9" label="Uptime Garantizado" suffix="%" delay={200} />
            <StatCard number="50" label="Velocidad de Redirección" suffix="ms" delay={400} />
            <StatCard number="100" label="Países Soportados" suffix="+" delay={600} />
            <StatCard number="24" label="Soporte Técnico" suffix="/7" delay={800} />
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl mb-8 opacity-90">
                ...
                para gestionar sus enlaces de manera profesional.
              </p>
