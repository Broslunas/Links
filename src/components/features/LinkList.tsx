...
export function LinkList({ onEditLink, onDeleteLink, refreshTrigger }: LinkListProps) {
    ...
    return (
      <div className="bg-card rounded-lg border border-border p-6">
        <div className="text-center py-8">
          ...
          <p className="text-red-500 font-medium mb-2">Error loading links</p>
    ...
    return (
      <div className="bg-card rounded-lg border border-border p-6">
        <div className="text-center py-8">
          ...
          <p className="text-muted-foreground font-medium mb-2">No links yet</p>
          <p className="text-muted-foreground text-sm">Create your first short link to get started</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-card rounded-lg border border-border">
      <div className="p-6 border-b border-border">
        <h2 className="text-xl font-semibold text-card-foreground">Your Links</h2>
        <p className="text-muted-foreground text-sm">Manage and track your shortened URLs</p>
      </div>
      
      <div className="divide-y divide-border">
        {links.map((link) => (
          <div key={link.id} className="p-6 hover:bg-muted/50 transition-colors">
