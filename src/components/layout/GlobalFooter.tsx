...
const footerSections: NavigationSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Precios (Proximamente)', href: '/pricing' },
      { label: 'API', href: '/docs' },
    ],
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <a
                href="https://broslunas.link/github"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 rounded-md p-1"
              ...
              <a
                href="https://broslunas.link/linkedin"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 rounded-md p-1"
                aria-label="Conéctate con nosotros en LinkedIn (se abre en una nueva ventana)"
                role="listitem"
              >
                <svg
                  className="h-5 w-5"
