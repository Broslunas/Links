...
const footerSections: NavigationSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Contacto', href: 'https://broslunas.com/contacto', external: true },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed mb-4">
                            Un acortador de URLs moderno con análisis avanzados, dominios personalizados
                            y potentes funciones de gestión de enlaces.
                        </p>
                        <div className="flex space-x-4">
                            ...
                            <a
                                href="https://linkedin.com/company/broslunas"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-gray-400 hover:text-white transition-colors"
                                aria-label="LinkedIn"
